...
\begin{lemma}[Source theorem for the prime generator]
  ...
  \uses{def:prime_generator,lem:contracted_prime_height,lem:counterexample_ring_weak}
...
\begin{proof}
  ...
  generic-fiber condition gives nonzeroness of the contraction, and the
  Farley criterion gives weak quasi-completeness of \(A\).
\end{proof}
...
\begin{definition}[Jensen completion witness]
  ...
  \(\widehat A\), a completion map \(A\to\widehat A\), an equivalence
  \(\widehat A\cong T\), compatibility with the embedded map \(A\to T\), and
  the weak quasi-completeness criterion expressed through this completion.
\end{definition}
...
\begin{proof}
  ...
  the embedded map \(A\to T\), it records an abstract completion
  \(\widehat A\), the completion map \(A\to\widehat A\), and an equivalence
  \(\widehat A\cong T\) compatible with the embedding.
\end{proof}
